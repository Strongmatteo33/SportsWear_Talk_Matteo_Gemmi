...
class AdminController extends Controller
{
    ...
    public function deleteTag(Tag $tag){
        ...
        return redirect(route('admin.dashboard'))->with('message', 'Hai correttamente cancellato il tag');
    }
    ...
    public function deleteCategory(Category $category){
        ...
        return redirect(route('admin.dashboard'))->with('message', 'Hai correttamente cancellato la categoria');
    }
